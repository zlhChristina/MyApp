    ...
    companion object {
        ...
        fun setStatusBar(activity: Activity) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {  //4.4到5.0
                ...
                statusBarView.setBackgroundColor(Color.parseColor("#F4D7A0"))
        ...
        fun setStatusBarTransparent(activity: Activity){
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                //设置让应用主题内容占据状态栏和导航栏
                val option = View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN or View.SYSTEM_UI_FLAG_HIDE_NAVIGATION or View.SYSTEM_UI_FLAG_LAYOUT_STABLE
